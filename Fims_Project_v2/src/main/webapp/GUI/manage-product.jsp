...
<link href="GUI/css/manager.css" rel="stylesheet" type="text/css" />
<link href="GUI/css/styleAdmin.css" rel="stylesheet" type="text/css" />
<style>
img {
	width: 100px;
	height: 200px;
			...
			<table class="table table-striped table-hover">
				...
				<tbody>
					...
					<tr>
						...
						<td><img src="GUI/images/products/<%=pi.getImage()%>">
						</td>
						<td><%=p.getCost()%>$</td>
						<td><a href="load-product?pid=<%=p.getId()%>" class="edit"
							data-toggle="modal"><i class="material-icons"
								data-toggle="tooltip" title="Edit">&#xE254;</i></a> <a
							href="delete-product?pid=<%=p.getId()%>" class="delete"
							data-toggle="modal"><i class="material-icons"
			...
			<div class="modal-content">
				<form action="add" method="post">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label>Model: </label> <select name="model" class="form-select"
