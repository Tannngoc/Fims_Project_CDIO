...
<body data-bs-spy="scroll" data-bs-target="#navbar"
		...
		<div class="search-popup-container">
			...
			<ul class="cat-list">
				<li class="cat-list-item"><a href="#" title="Mobile Phones">Mobile
						Phones</a></li>
				<li class="cat-list-item"><a href="#" title="Tablets">Tablets</a>
				</li>
				<li class="cat-list-item"><a href="#" title="Iphone">Iphone</a>
				</li>
				<li class="cat-list-item"><a href="#" title="Samsung">Samsung</a>
				</li>
			</ul>
    ...
    <nav id="header-nav" class="navbar navbar-expand-lg px-3 mb-3">
        <div class="container-fluid">
            <a class="navbar-brand" href="index.jsp">
                <img src="images/logo_FIMS.png" class="logo" style="width: 200px; height: 60px">
            </a>
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="bdNavbar" aria-labelledby="bdNavbarOffcanvasLabel">
                <div class="offcanvas-header px-4 pb-0">
                    <a class="navbar-brand" href="index.jsp">
                        <img src="images/logo_FIMS.png" class="logo">
                    </a>
                    <button type="button" class="btn-close btn-close-black" data-bs-dismiss="offcanvas" aria-label="Close" data-bs-target="#bdNavbar"></button>
                </div>
                <div class="offcanvas-body">
                    <ul id="navbar" class="navbar-nav text-uppercase justify-content-end align-items-center flex-grow-1 pe-3">
                        <li class="nav-item"><a class="nav-link me-4 active" href="index.jsp">Home</a></li>
                        <li class="nav-item"><a class="nav-link me-4" style="color: red" href="#mobile-products">HOT</a></li>
                        <li class="nav-item"><a class="nav-link me-4" href="../list-product">Products</a></li>
                        <li class="nav-item"><a class="nav-link me-4" href="#smart-watches">News</a></li>
                        <li class="nav-item"><a class="nav-link me-4" href="#yearly-sale">Services</a></li>
                                ...
                                <ul class="d-flex justify-content-end list-unstyled align-items-center">
                                    <li class="search-item pe-3">
                                        <a href="#" class="search-button">
                                            <svg class="search" width="24" height="24" viewBox="0 0 24 24">
                                    ...
                                    <li class="pe-3 dropdown">
                                        <button class="btn btn-warning dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                            <svg class="user" width="24" height="24" viewBox="0 0 24 24">
						...
						<div class="row d-flex align-items-center">
							...
							<div class="col-md-5">
								<div class="image-holder">
									<img src="images/iphone_14_pro_max.jpg.webp" alt="banner"
		...
		<div class="container">
			<div class="row">
				...
				<div class="swiper product-swiper">
					<div class="swiper-wrapper">
						<%
						// Gọi phương thức trong lớp DAO để lấy danh sách tài khoản
						ProductDAO pd = new ProductDAO();
						ProductImageDAO pid = new ProductImageDAO();
						ArrayList<Product> products = pd.selectAll();
						ArrayList<ProductImage> productImages = pid.selectAll();
						// Duyệt qua danh sách tài khoản và hiển thị thông tin
						...
						<div class="swiper-slide">
							<div class="product-card position-relative">
								<div class="image-holder">
									<img src="images/products/<%=pi.getImage()%>"
	...
	<section id="smart-watches"
		...
		<div class="container">
			<div class="row">
				<div class="display-header d-flex justify-content-between pb-3">
					<h2 class="display-7 text-dark text-uppercase">TABLETS</h2>
					<div class="btn-right">
						<a href="shop.html"
							class="btn btn-medium btn-normal text-uppercase">Go to Shop</a>
					</div>
				...
				<div class="swiper product-watch-swiper">
					<div class="swiper-wrapper">
						...
						<div class="swiper-slide">
							<div class="product-card position-relative">
								<div class="image-holder">
									<img src="images/product-item9.jpg" alt="product-item"
										class="img-fluid">
								</div>
								<div class="cart-concern position-absolute">
									<div class="cart-button d-flex">
						...
						<div class="swiper-slide">
							<div class="product-card position-relative">
								<div class="image-holder">
									<img src="images/product-item10.jpg" alt="product-item"
										class="img-fluid">
								</div>
								<div class="cart-concern position-absolute">
									<div class="cart-button d-flex">
                  ...
                  <use xlink:href="#quote" />
						...
						<div class="swiper-wrapper">
							<div
								...
								<div class="review-item col-md-10">
									...
									<blockquote>âTempus oncu enim pellen tesque este
										pretium in neque, elit morbi sagittis lorem habi mattis Pellen
										tesque pretium feugiat vel morbi suspen dise sagittis lorem
										habi tasse morbi.â</blockquote>
									<div class="rating">
                        ...
                        <use xlink:href="#star-empty"></use>
							...
							<div
								...
								<div class="review-item col-md-10">
									<i class="icon icon-review"></i>
									<blockquote>âA blog is a digital publication
										that can complement a website or exist independently. A blog
										may include articles, short posts, listicles, infographics,
										videos, and other digital content.â</blockquote>
									<div class="rating">
										<svg class="star star-fill">
                        <use xlink:href="#star-fill"></use>
                      </svg>
				...
				<div class="d-flex flex-wrap">
					<figure class="instagram-item pe-2">
						<a href="https://templatesjungle.com/"
							...
							src="images/insta-item1.jpg" alt="instagram" class="insta-image">
							<div
					...
					<figure class="instagram-item pe-2">
						<a href="https://templatesjungle.com/"
							class="image-link position-relative"> <img
							src="images/insta-item2.jpg" alt="instagram" class="insta-image">
							<div
								class="icon-overlay position-absolute d-flex justify-content-center">
								<svg class="instagram">
                    <use xlink:href="#instagram"></use>
					...
					<figure class="instagram-item pe-2">
						<a href="https://templatesjungle.com/"
							class="image-link position-relative"> <img
							src="images/insta-item3.jpg" alt="instagram" class="insta-image">
							<div
								class="icon-overlay position-absolute d-flex justify-content-center">
								<svg class="instagram">
                    <use xlink:href="#instagram"></use>
					...
					<figure class="instagram-item pe-2">
						<a href="https://templatesjungle.com/"
							class="image-link position-relative"> <img
							src="images/insta-item4.jpg" alt="instagram" class="insta-image">
							<div
								class="icon-overlay position-absolute d-flex justify-content-center">
								<svg class="instagram">
                    <use xlink:href="#instagram"></use>
					...
					<figure class="instagram-item pe-2">
						<a href="https://templatesjungle.com/"
							class="image-link position-relative"> <img
							src="images/insta-item5.jpg" alt="instagram" class="insta-image">
							<div
								class="icon-overlay position-absolute d-flex justify-content-center">
								<svg class="instagram">
                    <use xlink:href="#instagram"></use>
					...
					<div class="row d-flex flex-wrap justify-content-between">
						<div class="col-lg-3 col-sm-6 pb-3">
							<div class="footer-menu">
								<img src="images/logo_FIMS.png" alt="logo"
									style="width: 92px; height: 28px">
								<p>We are very pleased to offer the best quality services
									and products to customers.</p>
						...
						<div class="col-lg-3 col-sm-6 pb-3">
							<div class="footer-menu contact-item">
								...
								<p>
									Do you have any queries or suggestions? <a href="mailto:">fimsmobilestore@gmail.com</a>
								</p>
								<p>
									If you need support? Just give us a call. <a href="">+84
										918809264</a>
								</p>
							</div>
						</div>
		...
		<div class="container">
			<div class="row d-flex flex-wrap justify-content-between">
				...
				<div class="col-md-4 col-sm-6">
					<div class="copyright">
						<p>
							Â© Copyright 2024 FimsStore. Design by <a
